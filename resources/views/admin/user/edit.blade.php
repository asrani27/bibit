            ...
            <form class="form-horizontal" action="/superadmin/user/edit/{{$data->id}}" method="post">
                ...
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="nama_kelompok" class="form-control" value="{{$data->nama_kelompok}}" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Nama Ketua / Nama Pemimpin Kelompok</label>
                    <div class="col-sm-10">
                      <input type="text" name="name" class="form-control" value="{{$data->nama_kelompok}}" required>
                    </div>
                  </div>
                  <div class="form-group">
