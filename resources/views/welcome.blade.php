    ...
    <nav class="navbar navbar-static-top"  style="box-shadow: 0 8px 8px 0 rgba(0,0,0,.2);">
      <div class="container">
        <div class="navbar-header">
          <a href="#" class="navbar-brand"><b><i>SISTEM INFORMASI PERMOHONAN PENGAJUAN BANTUAN BIBIT PERKEBUNAN PADA DINAS PERTANIAN</i></b></a>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="text-center">
              <br/><br/>
              <br/><br/>
              <img src="/logo/logo2.png" width="20%">
            </div>
          <br/><br/>
            <div class="box box-success">
              <div class="box-header with-border text-center">
                <h3 class="box-title">HULU SUNGAI SELATAN </h3>
